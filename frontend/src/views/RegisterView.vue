      ...
      <div class="register-card">
        ...
        <form @submit.prevent="handleRegister" class="register-form">
          <div class="form-header">
            ...
            <p>Join us to manage your properties efficiently</p>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="input-wrapper">
              <input 
                ...
                required 
                class="form-input"
                :class="{ 'input-error': error && error.toLowerCase().includes('name') }"
          ...
          <div class="form-group">
            <label for="password_confirmation" class="form-label">
              <Shield :size="18" class="label-icon" />
              Confirm Password
            </label>
            <div class="input-wrapper">
              <input 
          ...
          <button type="submit" :disabled="loading" class="submit-button">
            <div class="button-content">
              ...
              <UserPlus v-else :size="18" class="register-icon" />
...
const form = ref<RegisterForm>({ name: '', email: '', password: '', password_confirmation: '' })
...
const handleRegister = async () => {
  ...
  try {
    ...
    await axios.post(createApiUrl('/register'), form.value, {
...
.submit-button:hover:not(:disabled) .register-icon {
